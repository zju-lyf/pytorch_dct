...
if __name__ == '__main__':
    ...
    parse.add_argument('--model_path', '-mp', type=str, default='./dct_/Resnet_bn_con1/best.pkl')
    parse.add_argument('--model1_path', '-mp1', type=str, default='./dct_/Resnet_bn_con1/20_resnet1.pkl')
    #parse.add_argument('--model2_path', '-mp2', type=str, default='./dct_/Resnet_sum_0/10_resnet2.pkl')
    main()
