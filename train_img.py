...
if __name__ == '__main__':
	...
	parse.add_argument('--name', '-n', type=str, default='Resnet_img')
	parse.add_argument('--train_path', '-tp' , type=str, default = '/home/liangyf/env/DCTAnalysis/ws/DCTAnalysis/data/FF/df/c23_df/train')
	parse.add_argument('--val_path', '-vp' , type=str, default = '/home/liangyf/env/DCTAnalysis/ws/DCTAnalysis/data/FF/df/c23_df/val')
	...
	parse.add_argument('--model_path', '-mp', type=str, default='./dct_/Resnet_img/best.pkl')
	main()
